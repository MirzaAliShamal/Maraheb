        ...
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative">
                ...
                <input type="text" id="search" data-kt-customer-table-filter="search"
                    class="form-control form-control-solid w-250px ps-15" placeholder="Search Departments"
                    autocomplete="off">
            </div>
            <!--end::Search-->
        </div>
        <div class="justify-content-end">
            <a href="{{ route('admin.department.add') }}" class="btn btn-primary add-item" data-bs-toggle="tooltip" title=""
...
@endsection
@section('js')
    <script src="{{ asset('assets/js/department/list.js') }}"></script>
@endsection
