...
@section('page-heading', 'Recruiters')
...
@section('breadcrumb')
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-dark">Incomplete Profiles</li>
    <!--end::Item-->
@endsection
        ...
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative">
                ...
                <input type="text" id="search" data-kt-customer-table-filter="search"
                    class="form-control form-control-solid w-250px ps-15" placeholder="Search Recruiters"
                    autocomplete="off">
            </div>
            <!--end::Search-->
        </div>
...
@endsection
@section('js')
    <script src="{{ asset('assets/js/recruiter/pending.js') }}"></script>
@endsection
