        ...
        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
            ...
            <div class="me-7 mb-4">
                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                    <img src="{{ $resturant_manager->profile }}" alt="image">
                </div>
            </div>
            <!--end::Pic-->
            <!--begin::Info-->
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <a href="javascript:;" class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1">{{ $resturant_manager->name }}</a>
                            @if ($resturant_manager->profile_status == 'approved')
                                <a href="javascript:;">
                            ...
                            @endif
                            @if ($resturant_manager->visibility_status)
                    ...
                    @if ($resturant_manager->profile_status == 'submitted')
                        <div class="d-flex my-4">
                            <a href="{{ route('admin.resturant.manager.profile.status', $resturant_manager->id) }}?action=approve" class="btn btn-sm me-2 btn-success delete-item">
                            ...
                            <a href="{{ route('admin.resturant.manager.profile.status', $resturant_manager->id) }}?action=reject" class="btn btn-sm btn-primary me-3 delete-item">
                                Reject
                            </a>
                        </div>
                    @endif
