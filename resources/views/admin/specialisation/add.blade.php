...
@section('breadcrumb')
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-dark">Add Specialisation</li>
    <!--end::Item-->
@endsection
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body py-10">
                <form action="{{ route('admin.specialisation.save') }}" method="POST" enctype="multipart/form-data" id="addForm">
                    @csrf
                    <div class="row">
                        <div class="col-lg-12">
...
@endsection
@section('js')
    <script src="{{ asset('assets/js/specialisation/add.js') }}"></script>
@endsection
