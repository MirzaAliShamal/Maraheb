...
@section('breadcrumb')
    ...
    <!--end::Item-->
    <!--begin::Item-->
    <li class="breadcrumb-item text-dark">Specialisations</li>
    <!--end::Item-->
@endsection
        ...
        <div class="card-title">
            ...
            <div class="d-flex align-items-center position-relative">
                ...
                <input type="text" id="search" data-kt-customer-table-filter="search"
                    class="form-control form-control-solid w-250px ps-15" placeholder="Search Specialisations"
                    autocomplete="off">
            </div>
            <!--end::Search-->
        </div>
        <div class="justify-content-end">
            <a href="{{ route('admin.specialisation.add') }}" class="btn btn-primary add-item" data-bs-toggle="tooltip" title=""
                data-bs-original-title="Add Specialisation">
...
@endsection
@section('js')
    <script src="{{ asset('assets/js/specialisation/list.js') }}"></script>
@endsection
