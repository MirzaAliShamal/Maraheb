							...
							<tr>
								<td align="left" valign="center">
									<div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
										...
										<div style="padding-bottom: 30px">CONGRATULATIONS! Your recruiter profile has just been approved, now you will be able to access your dashboard.</div>
										<div style="padding-bottom: 40px; text-align:center;">
											<a href="{{ route('recruiter.dashboard') }}" style="text-decoration:none;display:inline-block;text-align:center;padding:0.75575rem 1.3rem;font-size:0.925rem;line-height:1.5;border-radius:0.35rem;color:#ffffff;background-color:#009EF7;border:0px;margin-right:0.75rem!important;font-weight:600!important;outline:none!important;vertical-align:middle" target="_blank">
                                                Dashboard
                                            </a>
										</div>
										...
										<div style="padding-bottom: 50px; word-wrap: break-all;">
											...
											<a href="{{ route('recruiter.dashboard') }}" rel="noopener" target="_blank" style="text-decoration:none;color: #009EF7">
