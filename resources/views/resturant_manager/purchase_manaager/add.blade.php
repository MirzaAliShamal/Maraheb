                ...
                <div class="ls-widget">
                    <div class="tabs-box">
                        ...
                        <div class="widget-content">
                            <form action="{{ route('resturant.manager.purchase.manager.save') }}" method="POST" class="default-form" id="addForm">
                                @csrf
                                <div class="row">
...
@endsection
@section('js')
    <script src="{{ asset('js/resturant_manager/purchase_manager_add.js') }}"></script>
@endsection
